...
export const YOGA_TEACHERS_SILO: SiloContent = {
  ...
  organizerSeo: {
    audience: {
      ...
      [Language.ES]: 'Profesores de yoga que montan sus propios retiros',
      [Language.FR]: 'Professeurs de yoga qui construisent leurs propres retraites',
    },
    ...
    keywords: {
      ...
      [Language.ES]: [
        'lugar para retiros de yoga Países Bajos',
        'lugar para retiros de yoga Overijssel',
        'shala de yoga climatizada para retiros',
        'retiro de yin yoga',
        'retiro de vinyasa yoga',
        'retiro de yoga con buyout completo',
        'retiro residencial de yoga',
      ],
      [Language.FR]: [
        'lieu de retraite yoga Pays-Bas',
        'lieu de retraite yoga Overijssel',
        'shala de yoga chauffée pour retraite',
        'retraite de yin yoga',
        'retraite de vinyasa yoga',
        'retraite yoga avec privatisation complète',
        'retraite résidentielle de yoga',
      ],
    },
  },
}
