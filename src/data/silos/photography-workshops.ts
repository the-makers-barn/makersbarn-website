...
export const PHOTOGRAPHY_WORKSHOPS_SILO: SiloContent = {
  ...
  organizerSeo: {
    audience: {
      ...
      [Language.ES]: 'Fotógrafos profesionales que dirigen talleres de varios días',
      [Language.FR]: 'Photographes professionnels qui mènent des ateliers sur plusieurs jours',
    },
    ...
    keywords: {
      ...
      [Language.ES]: [
        'lugar para taller de fotografía Países Bajos',
        'taller de fotografía de paisaje',
        'retiro de fotografía fine art',
        'taller de fotografía documental',
        'taller de fotografía de retrato',
        'taller residencial de fotografía',
      ],
      [Language.FR]: [
        'lieu d’atelier photographie Pays-Bas',
        'atelier photographie de paysage',
        'retraite photographie fine art',
        'atelier photographie documentaire',
        'atelier photographie de portrait',
        'atelier photo résidentiel',
      ],
    },
  },
}
