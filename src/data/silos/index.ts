...
export { BEDRIJFSUITJE_OVERIJSSEL_SILO } from './bedrijfsuitje-overijssel'
...
export { COMPANY_DAY_EVENTS_SILO } from './company-day-events'
export { MEDITATION_RETREATS_SILO } from './meditation-retreats'
export { MEETING_VENUE_ZWOLLE_DEVENTER_SILO } from './meeting-venue-zwolle-deventer'
