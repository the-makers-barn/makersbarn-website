...
export const WELLNESS_DETOX_RETREATS_SILO: SiloContent = {
  ...
  heroImageAlt: {
    ...
    [Language.ES]: 'Yoga en el embarcadero junto al estanque de natación en The Makers Barn',
    [Language.FR]: 'Yoga sur le ponton au bord de l’étang de baignade à The Makers Barn',
  },
  meta: {
    title: {
      ...
      [Language.ES]: 'Lugar para retiros de bienestar y detox — Overijssel, Países Bajos',
      [Language.FR]: 'Lieu de retraite bien-être & détox — Overijssel, Pays-Bas',
    },
    description: {
      [Language.EN]:
      ...
      [Language.ES]:
        'Un lugar rural para coaches de bienestar, naturópatas y profesores de Ayurveda que dirigen programas de clean-eating, sauna y yoga en una finca privada de 1,3 hectáreas.',
      [Language.FR]:
        'Un lieu à la campagne pour coachs bien-être, naturopathes et enseignants d’Ayurveda qui animent des programmes de clean-eating, sauna et yoga sur une ferme privée de 1,3 hectares.',
    },
  },
  hero: {
    eyebrow: {
      ...
      [Language.ES]: 'Para coaches de bienestar y profesionales holísticos',
      [Language.FR]: 'Pour coachs bien-être et praticiens holistiques',
    },
    title: {
      ...
      [Language.ES]: 'Un lugar de slow-living para retiros de bienestar y detox',
      [Language.FR]: 'Un lieu slow-living pour retraites bien-être & détox',
    },
    subtitle: {
      [Language.EN]:
      ...
      [Language.ES]:
        'Sauna, estanque de natación, jacuzzi, granero de yoga y una cocina que nuestra red de cocineros sabe llenar de comida limpia y a tiempo.',
      [Language.FR]:
        'Sauna, étang de baignade, bain nordique, grange de yoga et une cuisine que notre réseau de cuisiniers sait remplir de clean food selon ton planning.',
    },
  },
  hook: {
    text: {
      ...
      [Language.ES]:
        'Sauna, descanso, el estanque, la cocina, y un programa que puedes moldear en torno a todo eso.',
      [Language.FR]:
        'Sauna, sommeil, l’étang, la cuisine, et un programme que tu peux construire autour de tout cela.',
    },
    caption: {
      [Language.EN]:
      ...
      [Language.ES]:
        'Para grupos de ocho a catorce, de tres a siete días, en régimen residencial.',
      [Language.FR]:
        'Pour des groupes de huit à quatorze, de trois à sept jours, en résidentiel.',
    },
  },
  sections: [
    {
      h2: {
        ...
        [Language.ES]: 'Un lugar construido para los pilares de un programa de bienestar',
        [Language.FR]: 'Un lieu pensé pour la structure d’un programme bien-être',
      },
      body: {
        [Language.EN]: [
        ...
        [Language.ES]: [
          'El granero Hay House para sesiones de yoga y respiración. La cocina en la segunda planta de Horizon para demos culinarias y comidas compartidas. La sauna y el jacuzzi para la práctica caliente-fría que quieras integrar en el día. El estanque de natación para los chapuzones en verano.',
          'Los retiros de bienestar aquí suelen correr dos sesiones de yoga al día, tres comidas, sauna al atardecer y una mañana tranquila. El lugar está hecho para que eso fluya, no para impresionar.',
        ],
        [Language.FR]: [
          'La grange Hay House pour les sessions de yoga et de respiration. La cuisine au deuxième étage de Horizon pour les démos culinaires et les repas partagés. Le sauna et le bain nordique pour la pratique chaud-froid que tu peux intégrer à la journée. L’étang de baignade pour les plongeons en été.',
          'Les retraites bien-être ici tournent généralement avec deux sessions de yoga par jour, trois repas, sauna au coucher du soleil, et une matinée lente. Le lieu est fait pour que ça coule, pas pour impressionner.',
        ],
      },
      ...
      imageAlt: {
        ...
        [Language.ES]: 'Jacuzzi en el campo en The Makers Barn',
        [Language.FR]: 'Bain nordique dans le champ à The Makers Barn',
      },
    },
    {
      h2: {
        ...
        [Language.ES]: 'Una cocina que nuestros cocineros saben llenar',
        [Language.FR]: 'Une cuisine que nos cuisiniers savent remplir',
      },
      body: {
        [Language.EN]: [
        ...
        [Language.ES]: [
          'Trabajamos con cocineros locales que hacen catering clean-eating, ayurvédico, de zumos y a base de plantas para grupos de catorce. Envíanos tu protocolo — ventanas de ayuno, sensibilidades alimentarias, los alimentos que tu retiro evita — y montamos la cocina en torno a eso antes de tu llegada.',
          'O trae a tu propio chef. La cocina está totalmente equipada, con espacio de preparación para dos cocineros trabajando en paralelo y almacenaje para una semana de productos frescos.',
        ],
        [Language.FR]: [
          'Nous travaillons avec des cuisiniers locaux qui font du clean-eating, de l’ayurvédique, des cures de jus et du végétal pour des groupes de quatorze. Envoie-nous ton protocole — fenêtres de jeûne, sensibilités alimentaires, les aliments que ta retraite évite — et nous préparons la cuisine en conséquence avant ton arrivée.',
          'Ou amène ton propre chef. La cuisine est entièrement équipée, avec un plan de travail pour deux cuisiniers en parallèle et le stockage pour une semaine de produits frais.',
        ],
      },
      ...
      imageAlt: {
        ...
        [Language.ES]: 'Cocina del granero Horizon, lista para cocinar en grupo',
        [Language.FR]: 'Cuisine de la grange Horizon, prête pour cuisiner ensemble',
      },
    },
    {
      h2: {
        ...
        [Language.ES]: 'Sauna, estanque y el ritmo caliente-frío',
        [Language.FR]: 'Sauna, étang et le rythme chaud-froid',
      },
      body: {
        [Language.EN]: [
        ...
        [Language.ES]: [
          'La sauna está a veinte pasos del estanque de natación. En verano el estanque está lo bastante templado para baños tranquilos; en invierno lo bastante frío como para que la práctica caliente-frío haga lo que tiene que hacer. El jacuzzi está al lado, para los días en que el estanque está helado o el grupo aún no está listo.',
          'La mayoría de los retiros de bienestar hacen sauna al final del día, con dos o tres rondas y chapuzones en el estanque entre medias. Si lo pides, la calentamos antes.',
        ],
        [Language.FR]: [
          'Le sauna se trouve à vingt pas de l’étang de baignade. En été, l’étang est assez chaud pour des nages tranquilles ; en hiver, assez froid pour que la pratique chaud-froid fasse ce qu’elle doit faire. Le bain nordique est juste à côté, pour les jours où l’étang est gelé ou le groupe pas encore prêt.',
          'La plupart des retraites bien-être font le sauna en fin de journée, avec deux ou trois rondes et des plongeons dans l’étang entre chaque. Sur demande, nous le chauffons plus tôt.',
        ],
      },
      ...
      imageAlt: {
        ...
        [Language.ES]: 'Estanque de natación natural en The Makers Barn',
        [Language.FR]: 'Étang de baignade naturel à The Makers Barn',
      },
    },
  ],
  facts: [
    {
      ...
      description: {
        ...
        [Language.ES]: 'Tamaño del grupo — buyout completo, sin otros huéspedes',
        [Language.FR]: 'Taille du groupe — privatisation complète, aucun autre invité',
      },
    },
    {
      number: '20',
      description: {
        ...
        [Language.ES]: 'Pasos desde la sauna hasta el estanque de natación',
        [Language.FR]: 'Pas du sauna jusqu’à l’étang de baignade',
      },
    },
    {
      number: '1,3 ha',
      description: {
        ...
        [Language.ES]: 'De terreno privado — plataforma de yoga, senderos, estanque, sauna, círculo de fuego',
        [Language.FR]: 'De terrain privé — deck de yoga, sentiers, étang, sauna, cercle de feu',
      },
    },
  ],
  faq: [
    {
      question: {
        ...
        [Language.ES]: '¿Podéis encargaros del catering de una cura de zumos o un protocolo de ayuno?',
        [Language.FR]: 'Pouvez-vous gérer la restauration d’une cure de jus ou d’un protocole de jeûne ?',
      },
      answer: {
        [Language.EN]:
        ...
        [Language.ES]:
          'Sí — nuestros cocineros han llevado curas de zumos prensados en frío, catering de ayuno intermitente y retiros ayurvédicos de monodieta. Envíanos el protocolo al reservar y lo presupuestamos con exactitud.',
        [Language.FR]:
          'Oui — nos cuisiniers ont assuré des cures de jus pressés à froid, du catering en jeûne intermittent, et des retraites ayurvédiques de mono-diète. Envoie-nous le protocole à la réservation et nous chiffrons précisément.',
      },
    },
    {
      question: {
        ...
        [Language.ES]: '¿Es seguro el estanque para baños en agua fría en invierno?',
        [Language.FR]: 'L’étang est-il sûr pour les bains en eau froide en hiver ?',
      },
      answer: {
        [Language.EN]:
        ...
        [Language.ES]:
          'Es un estanque natural, vallado, con embarcadero. La inmersión en agua fría siempre requiere que el facilitador principal informe a los participantes y supervise. Proporcionamos batas de secado y la sauna está justo al lado para volver a entrar en calor.',
        [Language.FR]:
          'C’est un étang naturel, clôturé, avec un ponton. L’immersion en eau froide demande toujours que le facilitateur principal briefe les participants et supervise. Nous fournissons des peignoirs et le sauna est juste là pour se réchauffer.',
      },
    },
    {
      question: {
        ...
        [Language.ES]: '¿Podemos reservar masajistas o terapeutas corporales in situ?',
        [Language.FR]: 'Peut-on réserver des masseurs ou praticiens corporels sur place ?',
      },
      answer: {
        [Language.EN]:
        ...
        [Language.ES]:
          'Sí — tenemos una pequeña red de terapeutas locales que se desplazan al lugar y usan la casa de té o un dormitorio tranquilo como espacio de tratamiento. Nosotros coordinamos los horarios para el grupo.',
        [Language.FR]:
          'Oui — nous avons un petit réseau de thérapeutes locaux qui se déplacent jusqu’au lieu et utilisent la maison de thé ou une chambre calme comme espace de soin. Nous coordonnons le planning pour le groupe.',
      },
    },
    {
      question: {
        ...
        [Language.ES]: '¿Cómo de pronto podemos dar una clase de yoga a las 6 de la mañana?',
        [Language.FR]: 'À quelle heure peut-on faire une session de yoga à 6 h du matin ?',
      },
      answer: {
        [Language.EN]:
        ...
        [Language.ES]:
          'La calefacción del Hay House funciona con un horario que ajustamos por reserva. Para una sesión a las 6:00 calentamos el suelo desde las 5:30. La cocina se pone en marcha a la hora que nos digas que necesitas el desayuno.',
        [Language.FR]:
          'Le chauffage du Hay House suit un planning que nous réglons à chaque réservation. Pour une session à 6 h, nous chauffons le sol dès 5 h 30. La cuisine se met en route à l’heure que tu nous indiques pour le petit-déjeuner.',
      },
    },
  ],
  finalCta: {
    title: {
      ...
      [Language.ES]: 'Lleva tu programa de bienestar a una finca hecha para eso',
      [Language.FR]: 'Anime ton programme bien-être dans une ferme faite pour ça',
    },
    body: {
      [Language.EN]:
      ...
      [Language.ES]:
        'Dinos tus fechas, el tamaño del grupo y el protocolo en torno al cual está construido tu retiro. Volveremos con disponibilidad, presupuesto de cocina y una oferta a medida.',
      [Language.FR]:
        'Dis-nous tes dates, la taille du groupe et le protocole autour duquel ta retraite est bâtie. Nous revenons avec les disponibilités, le chiffrage cuisine et un devis sur mesure.',
    },
  },
  organizerSeo: {
    audience: {
      ...
      [Language.ES]: 'Coaches de bienestar, naturópatas y profesores de Ayurveda con programas de clean-eating, sauna y yoga',
      [Language.FR]: 'Coachs bien-être, naturopathes et enseignants d’Ayurveda avec des programmes clean-eating, sauna et yoga',
    },
    ...
    keywords: {
      ...
      [Language.ES]: [
        'lugar para retiros de bienestar Países Bajos',
        'lugar para retiros detox',
        'retiro de Ayurveda',
        'retiro de panchakarma',
        'retiro de clean-eating',
        'retiro de sauna',
        'retiro holístico',
      ],
      [Language.FR]: [
        'lieu de retraite bien-être Pays-Bas',
        'lieu de retraite détox',
        'retraite Ayurveda',
        'retraite panchakarma',
        'retraite clean-eating',
        'retraite sauna',
        'retraite holistique',
      ],
    },
