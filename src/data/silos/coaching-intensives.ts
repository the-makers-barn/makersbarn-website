...
export const COACHING_INTENSIVES_SILO: SiloContent = {
  ...
  organizerSeo: {
    audience: {
      ...
      [Language.ES]: 'Coaches ejecutivos y facilitadores certificados por ICF que dirigen intensivos de 8 a 12 personas',
      [Language.FR]: 'Coachs exécutifs et facilitateurs certifiés ICF qui animent des intensifs de 8 à 12 personnes',
    },
    ...
    keywords: {
      ...
      [Language.ES]: [
        'lugar para retiros de coaching',
        'offsite de coaching ejecutivo',
        'retiro de cohorte ICF',
        'intensivo de liderazgo',
        'retiro mastermind',
        'desarrollo de liderazgo Países Bajos',
      ],
      [Language.FR]: [
        'lieu de retraite coaching',
        'offsite de coaching exécutif',
        'retraite de cohorte ICF',
        'intensif de leadership',
        'retraite mastermind',
        'développement du leadership Pays-Bas',
      ],
    },
  },
}
