...
export const TEAM_OFFSITES_SILO: SiloContent = {
  ...
  organizerSeo: {
    audience: {
      ...
      [Language.ES]: 'Fundadores, responsables de personas y directores creativos que planean offsites slow-living',
      [Language.FR]: 'Fondateurs, responsables RH et directeurs créatifs qui organisent des offsites slow-living',
    },
    ...
    keywords: {
      ...
      [Language.ES]: [
        'lugar para team offsite Países Bajos',
        'retiro de empresa',
        'offsite de liderazgo',
        'offsite de estrategia Overijssel',
        'lugar de team building cerca de Schiphol',
        'offsite de fundadores',
      ],
      [Language.FR]: [
        'lieu de team offsite Pays-Bas',
        'retraite d’entreprise',
        'offsite de leadership',
        'offsite stratégique Overijssel',
        'lieu de team building près de Schiphol',
        'offsite de fondateurs',
      ],
    },
  },
}
