...
export const en: Dictionary = {
  ...
  tools: {
    hub: {
      ...
      workflowIntro: 'Each tool stands alone, but together they cover the full arc — from sanity-check to schedule.',
      workflowSteps: [
      ...
      categories: {
        ...
        planner: {
          ...
          description: 'Four runways from a 3-month sprint to a 12-month build. Phase-by-phase milestones you can check off, customise, and email to yourself.',
        },
        agenda: {
