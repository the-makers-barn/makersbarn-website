  ...
  tools: {
    ...
    calculator: {
      inputs: {
        ...
        coFacilitatorsLabelCoLed: 'Co-facilitator pay',
        coFacilitatorsLabelOrganizer: 'Additional facilitators / teachers',
        coFacilitatorsHelperCoLed: 'Total fee paid out to your co-facilitator(s) — does not flow back to you',
        coFacilitatorsHelperOrganizer: 'Total fees for additional teachers, guest speakers, or assistants you hire',
