    ...
    calendar: {
      ...
      faq: {
        ...
        entries: [
          ...
          { question: 'When is the latest I can cancel a retreat without losing the venue payment?', answer: 'Most retreat venues — MakersBarn included — require near-full payment around 2 months before the retreat, and that payment is non-refundable. Treat the 2-month mark as a hard go/no-go deadline: if you have not hit your minimum-viable headcount by then, the cost of going ahead under-filled is now sunk either way. Lock the decision a few weeks before the deadline, not on the day.' },
