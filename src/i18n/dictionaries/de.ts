    ...
    calendar: {
      ...
      faq: {
        ...
        entries: [
          ...
          { question: 'Bis wann kann ich ein Retreat absagen, ohne die Locationzahlung zu verlieren?', answer: 'Die meisten Retreat-Locations — MakersBarn eingeschlossen — verlangen rund 2 Monate vor dem Retreat fast die vollständige Zahlung, und diese ist nicht erstattungsfähig. Betrachte den 2-Monats-Punkt als harte Go/No-Go-Deadline: Hast du bis dahin deine Mindestteilnehmerzahl nicht erreicht, sind die Kosten für ein unterbelegtes Retreat ohnehin angefallen. Triff die Entscheidung ein paar Wochen vor der Deadline, nicht am Tag selbst.' },
