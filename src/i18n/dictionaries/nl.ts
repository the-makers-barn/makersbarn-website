  ...
  tools: {
    ...
    calculator: {
      inputs: {
        ...
        coFacilitatorsLabelCoLed: 'Vergoeding co-begeleider',
        coFacilitatorsLabelOrganizer: 'Extra begeleiders / docenten',
        coFacilitatorsHelperCoLed: 'Totale uitbetaling aan je co-begeleider(s) — komt niet terug naar jou',
        coFacilitatorsHelperOrganizer: 'Totale vergoedingen voor extra docenten, gastsprekers of assistenten die je inhuurt',
