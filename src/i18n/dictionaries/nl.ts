...
export const nl: Dictionary = {
  ...
  tools: {
    hub: {
      ...
      workflowIntro: 'Elke tool staat op zichzelf, maar samen dekken ze de hele boog — van sanity-check tot schema.',
      workflowSteps: [
      ...
      categories: {
        ...
        planner: {
          ...
          description: 'Vier looptijden van een sprint van 3 maanden tot een opbouw van 12 maanden. Mijlpalen per fase die je kunt afvinken, aanpassen en naar jezelf mailen.',
        },
        agenda: {
