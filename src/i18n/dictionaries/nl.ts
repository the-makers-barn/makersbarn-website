    ...
    calendar: {
      ...
      faq: {
        ...
        entries: [
          ...
          { question: 'Wat is het laatste moment om een retraite te annuleren zonder de locatiebetaling kwijt te raken?', answer: 'De meeste retraitelocaties — MakersBarn ook — vragen ongeveer 2 maanden voor de retraite bijna de volledige betaling, en die is niet-restitueerbaar. Behandel het 2-maanden-moment als een harde go/no-go-deadline: als je dan je minimum-aantal deelnemers nog niet hebt, zijn de kosten van doorgaan met een halflege groep vanaf nu toch al gemaakt. Maak de beslissing een paar weken voor de deadline, niet op de dag zelf.' },
