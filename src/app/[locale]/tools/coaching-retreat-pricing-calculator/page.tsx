...
const VARIANT = ToolVariant.COACHING
const ROUTE = Route.COACHING_RETREAT_PRICING_CALCULATOR
...
export default async function CoachingCalculatorPage({ params }: PageProps) {
  const { locale } = await params
  const validLocale = getValidLocale(locale)
