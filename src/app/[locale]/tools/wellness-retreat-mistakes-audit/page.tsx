...
const VARIANT = AuditVariant.WELLNESS
const ROUTE = Route.WELLNESS_RETREAT_MISTAKES_AUDIT
...
export default async function WellnessRetreatMistakesAuditRoute({ params }: PageProps) {
  const { locale } = await params
  const validLocale = getValidLocale(locale)
