...
const VARIANT = AuditVariant.COACHING
const ROUTE = Route.COACHING_RETREAT_MISTAKES_AUDIT
...
export default async function CoachingRetreatMistakesAuditRoute({ params }: PageProps) {
  const { locale } = await params
  const validLocale = getValidLocale(locale)
