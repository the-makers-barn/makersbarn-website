...
const VARIANT = AuditVariant.FIRST_TIME
const ROUTE = Route.FIRST_TIME_RETREAT_HOST_AUDIT
...
export default async function FirstTimeRetreatHostAuditRoute({ params }: PageProps) {
  const { locale } = await params
  const validLocale = getValidLocale(locale)
