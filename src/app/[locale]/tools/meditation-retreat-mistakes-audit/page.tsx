...
const VARIANT = AuditVariant.MEDITATION
const ROUTE = Route.MEDITATION_RETREAT_MISTAKES_AUDIT
...
export default async function MeditationRetreatMistakesAuditRoute({ params }: PageProps) {
  const { locale } = await params
  const validLocale = getValidLocale(locale)
