...
const PAGE_ROUTES: readonly PageRoute[] = [
  ...
  { path: Route.MENS_SWEAT_LODGE, changeFrequency: 'weekly', priority: 0.8 },
  ...
  { path: Route.COMPANY_DAY_EVENTS, changeFrequency: 'monthly', priority: 0.85 },
  { path: Route.BEDRIJFSUITJE_OVERIJSSEL, changeFrequency: 'monthly', priority: 0.85 },
  { path: Route.MEETING_VENUE_ZWOLLE_DEVENTER, changeFrequency: 'monthly', priority: 0.85 },
