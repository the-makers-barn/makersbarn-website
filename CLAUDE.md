...
Supports three locales (EN, NL, DE) — write proper translations for new copy in each.
- **Dictionaries**: Translation files in `src/i18n/dictionaries/` (en.ts, nl.ts, de.ts)
